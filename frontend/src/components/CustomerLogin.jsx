...
import { checkCustomerThunk, verifyCustomerThunk } from "../../store/customerSlice";
import { setCustomerField, setAuthState } from "../../store/customerSlice";

export default function CustomerLogin({ onBack }) {
