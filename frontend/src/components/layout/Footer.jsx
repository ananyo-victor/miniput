...
import { Link, useLocation } from "react-router"; // Assuming useLocation for the active state indicator
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-2">
        <div className="flex justify-around items-end">
          ...
          <Link to="/" className="flex flex-col items-center group">
            <img
              src="/path-to-your-icons/home-icon.png"
              alt="Home"
            ...
            {isActive('/') && <div className="w-1.5 h-1.5 bg-yellow-400 rounded-full mt-0.5"></div>}
          </Link>

          {isAdmin && <Link to="/customer/shop" className="flex flex-col items-center group">
            <img
              src="/path-to-your-icons/box-icon.png"
              alt="Inventory"
              className="w-8 h-8 mb-1"
            />
          ...
          {!isAdmin && (
            <Link to="/customer/cart" className="flex flex-col items-center group">
              <img
                src="/path-to-your-icons/cart-icon.png"
                alt="Cart"
                className="w-8 h-8 mb-1"
              />
