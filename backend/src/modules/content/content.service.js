...
exports.upsertHomeContentByBrand = async (brandInput, payload) => {
    const brand = normalizeBrand(brandInput);
...
exports.upsertAboutContent = async (payload) => {
    const next = {
    ...
    const asValue = (value) => (value === undefined ? null : String(value || '').trim());
