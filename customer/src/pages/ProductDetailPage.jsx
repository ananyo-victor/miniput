        ...
        <div className="bg-white rounded-t-3xl -mt-6 md:mt-0 md:rounded-none flex-1 p-5 md:p-6 lg:p-8 z-10 relative flex flex-col w-full md:w-1/2 overflow-y-auto mk-scroll-hidden">
          <div className="flex items-center justify-between w-full max-w-lg mb-4">
            ...
            <div className="flex items-center gap-2.5 text-[9px] font-black text-gray-400 tracking-widest uppercase">
              <button onClick={() => goToIndex(currentIndex - 1)} type="button" className="flex items-center gap-0.5 hover:text-gray-900 transition-colors">
          ...
          <div className="max-w-lg my-auto w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-4">
              <button
                onClick={() => {
                  if (authed) {
                    navigate("/order", {
                      state: {
                        directOrderItem: { ...currentProduct, quantity, selectedSizes },
                      },
                    });
                  } else {
                    dispatch(openAuthModal());
              ...
              <button
                onClick={() => {
                  if (authed) {
                    dispatch(addToCart({ productId: currentProduct.id, quantity, size: selectedSizes }))
